...
class TestDummyArray:
    ...
    def test_to_dict(self):
        ...
        arr = DummyArray(dims=["time"], attrs={"units": "days"}, data=np.array([1, 2, 3]))
        result = arr.to_dict()
    ...
    def test_repr_with_data(self):
        ...
        arr = DummyArray(dims=["time"], attrs={"units": "K"}, data=np.array([1, 2, 3, 4, 5]))
        repr_str = repr(arr)
...
class TestDummyDataset:
    ...
    def test_add_variable(self):
        ...
        ds = DummyDataset()
        ds.add_dim("time", 12)
        ds.add_variable("tas", ["time"], attrs={"units": "K", "long_name": "temperature"})
    ...
    def test_encoding_preserved(self):
        ...
        data = np.random.rand(10)
        ds.add_variable("test", data=data, encoding={"dtype": "float32", "chunks": (5,)})
    ...
    def test_to_zarr(self, tmp_path):
        ...
        ds.add_variable("tas", ["time"], data=temp_data, encoding={"dtype": "float32"})
    ...
    def test_from_xarray_with_data(self):
        ...
        xr_ds = xr.Dataset(
            data_vars={"temperature": (["time", "lat"], temp_data)},
        ...
        np.testing.assert_array_equal(dummy_ds.variables["temperature"].data, temp_data)
        np.testing.assert_array_equal(dummy_ds.coords["time"].data, time_data)
    ...
    def test_from_xarray_preserves_encoding(self):
        ...
        xr_ds = xr.Dataset(data_vars={"temperature": (["time"], np.random.rand(10))})
    ...
    def test_populate_with_random_data_reproducible(self):
        ...
        np.testing.assert_array_equal(ds1.variables["temp"].data, ds2.variables["temp"].data)
    ...
    def test_populate_different_variable_types(self):
        ...
        ds.add_variable("pr", ["time"], attrs={"standard_name": "precipitation_flux"})
        ds.add_variable("psl", ["time"], attrs={"standard_name": "air_pressure_at_sea_level"})
